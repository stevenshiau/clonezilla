...
Requires:	bash, perl, drbl >= 2.13.7, partimage >= 0.6.7, psmisc, udpcast, partclone >= 0.2.76, ntfsprogs >= 1.13.1
...
%changelog
* Tue Mar 04 2015 Steven Shiau <steven _at_ nchc org tw> 3.13.30-drbl1
