...
Requires:	bash, perl, drbl >= 2.1.35, partimage >= 0.6.7, psmisc, udpcast, partclone >= 0.2.56, ntfsprogs >= 1.13.1
...
- The options "-j" and "-n" of ocs-iso and ocs-live-dev were removed because it's seldom used.
- No more using templiate iso from reporitory, now we use clonezilla live iso when running ocs-iso or ocs-live-dev to create a recovery iso or zip.
